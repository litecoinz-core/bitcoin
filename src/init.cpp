 ...
 */
static const char* BITCOIN_PID_FILENAME = "litecoinzd.pid";
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/litecoinz-core/litecoinz>";
    ...
    while (!fLoaded && !ShutdownRequested()) {
        ...
        do {
            ...
            try {
                ...
                pblocktree.reset();
                pblocktree.reset(new CBlockTreeDB(nBlockTreeDBCache, false, fReset, dbCompression));
