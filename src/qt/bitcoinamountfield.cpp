...
public:
    ...
    QSize minimumSizeHint() const
    {
        if(cachedMinimumSizeHint.isEmpty())
        {
            ...
            int w = GUIUtil::TextWidth(fm, BitcoinUnits::format(BitcoinUnits::LTZ, BitcoinUnits::maxMoney(), false, BitcoinUnits::separatorAlways));
...
private:
    int currentUnit{BitcoinUnits::LTZ};
