...
QString formatBitcoinURI(const SendCoinsRecipient &info)
{
    ...
    QString ret = QString("litecoinz:%1").arg(bech_32 ? info.address.toUpper() : info.address);
    int paramCount = 0;
...
bool openBitcoinConf()
{
    ...
    /* Open litecoinz.conf with the associated application */
...
fs::path static GetAutostartFilePath()
{
    ...
    return GetAutostartDir() / strprintf("litecoinz-%s.desktop", chain);
}
