...
void WalletInit::AddWalletOptions() const
{
    ...
    gArgs.AddArg("-sendchangeback", strprintf("Send change back to from t address if possible (default: %u)", DEFAULT_SEND_CHANGE_BACK), ArgsManager::ALLOW_ANY, OptionsCategory::WALLET);
