...
void WalletInit::AddWalletOptions() const
{
    ...
    gArgs.AddArg("-migration", "Enable the Sprout to Sapling migration", ArgsManager::ALLOW_ANY, OptionsCategory::WALLET);
    gArgs.AddArg("-migrationdestaddress=<zaddr>", "Set the Sapling migration address", ArgsManager::ALLOW_ANY, OptionsCategory::WALLET);
    ...
    gArgs.AddArg("-txexpirydelta", strprintf("Set the number of blocks after which a transaction that has not been mined will become invalid (min: %u, default: %u)", TX_EXPIRING_SOON_THRESHOLD + 1, DEFAULT_TX_EXPIRY_DELTA), ArgsManager::ALLOW_ANY, OptionsCategory::WALLET);
