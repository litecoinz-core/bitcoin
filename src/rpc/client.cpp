...
static const CRPCConvertParam vRPCConvertParams[] =
{
    ...
    { "createrawtransaction", 3, "expiryheight" },
    ...
    { "walletcreatefundedpsbt", 3, "expiryheight" },
    ...
    { "z_getoperationresult", 0, "operationid" },
    { "z_getoperationstatus", 0, "operationid" },
    ...
    { "z_listaddresses", 0, "includeWatchonly"},
    { "z_importkey", 2, "rescan" },
    { "z_importviewingkey", 2, "rescan" },
