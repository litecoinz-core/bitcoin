...
public:
    CMainParams() {
        ...
        consensus.DropSproutHeight = 670000;
        ...
        hashSproutValuePoolCheckpointBlock = uint256S("0x00001531c60bc5d9730693ead57f49ec26d175d548360c47b0cf80af24dc5d28");
    }
};
...
public:
    CTestNetParams() {
        ...
        consensus.DropSproutHeight = 7000;
