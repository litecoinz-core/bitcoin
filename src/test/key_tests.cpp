...
static const std::string addr1 = "L1WzxjmtKnCmK3aBWLgCWWdPDfQ28Nckuw9";
static const std::string addr2 = "L1Mq5yeVN4jHNzpCADG1Gmu9rvvudXAHm9p";
static const std::string addr1C = "L1VYRmEHzfWP9fPBBLdkzV197kC6uMJsQbp";
static const std::string addr2C = "L1KAqviPTiKjLzU3oNXCeTmVVa38pm34qzx";
