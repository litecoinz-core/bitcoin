...
**LitecoinZ Core's `configure` script by default will ignore the depends output.** In
...
- `FALLBACK2_DOWNLOAD_PATH`: If a source file can't be fetched, try here before giving up
