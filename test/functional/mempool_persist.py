...
By default, litecoinzd will dump mempool on shutdown and
...
class MempoolPersistTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent litecoinzd from writing mempool.dat to disk. Verify that `savemempool` fails")
