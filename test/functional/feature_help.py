...
"""Verify that starting litecoinz with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start litecoinz with -h for help text")
        ...
        self.log.info("Start litecoinz with -version for version information")
        ...
        self.log.info("Start litecoinzd with -fakearg to make sure it does not start")
