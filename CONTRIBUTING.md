...
[good first issue](https://github.com/litecoinz-core/litecoinz/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
list.

Communication Channels
----------------------

Most communication about LitecoinZ Core development happens on IRC, in the
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to litecoinz-qt
  ...
  - `test` for changes to the litecoinz unit tests or QA tests
...
[Translation Process](https://github.com/litecoinz/litecoinz/blob/master/doc/translation_process.md)
