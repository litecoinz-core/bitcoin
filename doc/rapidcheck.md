# RapidCheck property-based testing for Litecoinz Core

## Concept

Property-based testing is experimentally being added to Litecoinz Core with
...
If RapidCheck is installed, Litecoinz Core will automatically run the
...
3. Configure Litecoinz Core with RapidCheck.

    `cd` to the directory of your local litecoinz repository and run
...
4. Build Litecoinz Core with RapidCheck.
...
That's it! You are now running property-based tests in Litecoinz Core.
