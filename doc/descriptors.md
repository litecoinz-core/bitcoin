# Support for Output Descriptors in LitecoinZ Core
...
existing LitecoinZ Core wallets, a convenience function `combo` is
...
All RPCs in LitecoinZ Core will include the checksum in their output. Only
