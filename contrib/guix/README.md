# Bootstrappable LitecoinZ Core Builds

This directory contains the files necessary to perform bootstrappable LitecoinZ
Core builds.
...
- 24GB of free disk space on the partition that the LitecoinZ Core git repository
  resides in
...
For a LitecoinZ Core depends development environment, simply invoke
...
From the top of a clean LitecoinZ Core repository:
...
To use dongcarl's substitute server for LitecoinZ Core builds after having
