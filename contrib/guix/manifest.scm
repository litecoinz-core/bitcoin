...
(define* (make-litecoinz-cross-toolchain target
                                  #:key
...
(packages->manifest
 (list ;; The Basics
       ...
       (make-litecoinz-cross-toolchain "i686-linux-gnu")
       (make-litecoinz-cross-toolchain "x86_64-linux-gnu")
       (make-litecoinz-cross-toolchain "aarch64-linux-gnu")
       (make-litecoinz-cross-toolchain "arm-linux-gnueabihf")
       ...
       (make-litecoinz-cross-toolchain "riscv64-linux-gnu"
