...
def main():
    ...
    # Filter out hosts with multiple litecoinz ports, these are likely abusive
    ips = filtermultiport(ips)
    print('%s Filter out hosts with multiple litecoinz ports' % (ip_stats(ips)), file=sys.stderr)
