...
Files used during the gitian build process. For more information about gitian, see the [the Litecoinz Core documentation repository](https://github.com/litecoinz-core/docs).
